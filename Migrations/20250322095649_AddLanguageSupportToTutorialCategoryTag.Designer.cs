...
namespace Berrevoets.TutorialPlatform.Migrations
{
    ...
    [Migration("20250322095649_AddLanguageSupportToTutorialCategoryTag")]
    partial class AddLanguageSupportToTutorialCategoryTag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Berrevoets.TutorialPlatform.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Berrevoets.TutorialPlatform.Models.Chapter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Berrevoets.TutorialPlatform.Models.UserChapterProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Berrevoets.TutorialPlatform.Models.UserTutorialProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Berrevoets.TutorialPlatform.Models.Certificates.IssuedCertificate", b =>
                {
                    ...
                    b.HasOne("Berrevoets.TutorialPlatform.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Berrevoets.TutorialPlatform.Models.UserChapterProgress", b =>
                {
                    b.HasOne("Berrevoets.TutorialPlatform.Models.Chapter", "Chapter")
                        .WithMany()
                    ...
                    b.HasOne("Berrevoets.TutorialPlatform.Models.UserTutorialProgress", null)
                        .WithMany("Chapters")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Berrevoets.TutorialPlatform.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TagTutorial", b =>
                {
                    b.HasOne("Berrevoets.TutorialPlatform.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Berrevoets.TutorialPlatform.Models.Tutorial", null)
                        .WithMany()
